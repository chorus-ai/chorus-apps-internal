...
export default function Form({ qid, value, setter }: { qid: any; value: any; setter: any }) {
  ...
  const onNumOfWordsChange = (e: any) => {
  ...
  const onReadingLevelChange = (e: any) => {
  ...
  const onCompletenessChange = (e: any) => {
  ...
  const onComprehensibilityChange = (e: any) => {
