...
function ___removeStartsWith(str: any, substringToRemove: any) {
      ...
      try {
        ...
        if (fileContent && fileContent.info) {
          const updatedFileContent = {
            ...fileContent,
            info: fileContent.info.filter((hobby: any) =>
                    ...
                    aNotes[events[eIdx].id][
                      ...
                      <div>
                        ...
                        >
                          ...
                          {/* Factuality */}
                          <Typography variant="subtitle1">Factuality</Typography>
                        ...
                        >
                          ...
                          {/* Logicality */}
                          <Typography variant="subtitle1">Logicality</Typography>
