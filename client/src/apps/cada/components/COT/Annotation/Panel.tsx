...
export default function Panel({ ___user, project, events, eIdx, setEIdx }: { ___user?: any; project: any; events: any; eIdx: any; setEIdx: any }) {
  ...
  const handleChange = (field: any, label: any) => (e: any) => {
  ...
  const handlePrevious = () => {
    handleSave();
    setEIdx((curr: any) => curr > 0 ? curr - 1 : curr);
  }
