...
import { updateAdjudication, updateAnnotation } from '../../../../store/thunk';
;
...
export default function Selected({ project, events, ____selectedIds, ____aNotes, ____adjNotes, ____annotationResult, ___setAnnotationNotes }) {
  ...
  const onHighlightClick = (conceptIdx: any) => () => {
    setCIdx(conceptIdx);
  }
          ...
          <Grid container direction="row">
            ...
            <Grid>
              ...
              >
                ...
                <Form cIdx={cIdx} value={values[cIdx]} setValue={(v: any) => setValues({ ...values, [cIdx]: v })} event={events[eIdx]} note={note} pid={project?.id} />
              </Box>
            </Grid>
          </Grid>
        )}
