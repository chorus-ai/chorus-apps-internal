// services/omop/drug_exposure.js
...
exports.findAll = (page, pageSize, sortOrder) => {
  const { order, offset, limit } = getPaginationAndSort(page, pageSize, sortOrder, "drug_exposure_id");
...
/**
 * 6. Advanced Search for Drug Exposures
 */
exports.advancedSearch = (searchParams, page, pageSize, sortOrder) => {
  ...
  for (const key of Object.keys(searchParams)) {
    ...
    } else if (key.endsWith("_value") || ["stop_reason", "sig", "lot_number"].includes(key)) {
