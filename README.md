...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Getting Started</strong></td><td>Install dependencies, configure the environment, and run the client and server locally.</td><td></td><td><a href="docs/getting-started.md">getting-started.md</a></td></tr><tr><td><strong>Architecture</strong></td><td>How the client, server, features, databases, and background jobs fit together.</td><td></td><td><a href="docs/architecture.md">architecture.md</a></td></tr><tr><td><strong>Features</strong></td><td>What each feature app (CADA, IVE, M2D, OMOP, Vocabulary, Form, Assets) does.</td><td></td><td><a href="docs/features.md">features.md</a></td></tr><tr><td><strong>Environment Variables</strong></td><td>Every variable the server reads, what it's for, and when it's required.</td><td></td><td><a href="docs/env-variables.md">env-variables.md</a></td></tr></tbody></table>
