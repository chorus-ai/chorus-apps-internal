...
export default function Form({ qid, value, setter }) {
  const [numOfWordsValue, setNumOfWordsValue] = useState(
    value?.numOfWords || null
  );
  const [readingLevelValue, setReadingLevelValue] = useState(
  ...
  const [relevenceValue, setRelevanceValue] = useState(
    value?.relevance || null
  );
  const [completenessValue, setCompletenessValue] = useState(
    value?.completeness || null
  );
  const [comprehensibilityValue, setComprehensibilityValue] = useState(
    value?.comprehensibility || null
  );
      ...
      <Grid container spacing={2} p={1} pt={1.5}>
        ...
        <Grid item xs={12}>
          <FormControl>
            ...
            <RadioGroup row value={clarityValue} onChange={onClarityChange}>
              <FormControlLabel value="yes" control={<Radio />} label="Yes" />
              <FormControlLabel
                value="partially"
                control={<Radio />}
        ...
        <Grid item xs={12}>
          <FormControl>
            ...
            <RadioGroup row value={accuracyValue} onChange={onAccuracyChange}>
              <FormControlLabel value="yes" control={<Radio />} label="Yes" />
              <FormControlLabel
                value="partially"
                control={<Radio />}
        ...
        <Grid item xs={12}>
          <FormControl>
            ...
            <RadioGroup row value={relevenceValue} onChange={onRelevanceChange}>
              <FormControlLabel value="yes" control={<Radio />} label="Yes" />
              <FormControlLabel
                value="partially"
                control={<Radio />}
